...
API paths not listed above can be called with **Custom API Call**. [`swagger.json`](./swagger.json) at the repo root is the OpenAPI reference for discovering endpoints and payloads.

import { GenericValue, IExecuteFunctions, IDataObject, INodeExecutionData } from 'n8n-workflow';
...
export async function execute(
	...
	const response = await apiRequest.call(this, 'POST', '/Attachment/document', body as GenericValue[], {});

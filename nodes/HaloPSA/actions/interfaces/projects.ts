...
export interface HaloProjectsListResponse extends IDataObject {
	record_count: number;
	faults: HaloProjectSummary[];
	include_children: boolean;
}

export interface HaloProjectSummary extends IDataObject {
	id: number;
	dateoccurred?: string;
	summary?: string;
	details?: string;
...
export interface HaloProjectDetailed extends HaloProjectSummary {
...
export interface HaloProjectCreate extends IDataObject {
	summary: string;
...
export interface HaloProjectUpdate extends Partial<HaloProjectCreate> {
	id: number;
}
...
export type HaloPSAResource = 'actions' | 'agents' | 'assets' | 'client' | 'contracts' | 'fieldInfo' | 'invoices' | 'knowledgeBase' | 'reporting' | 'sites' | 'tickets' | 
...
export interface HaloPSA {
	...
	operation: HaloPSAActionsOperation | HaloPSAAgentsOperation | HaloPSAAssetsOperation | HaloPSAClientOperation |
		HaloPSAContractsOperation | HaloPSAFieldInfoOperation | HaloPSAInvoicesOperation | HaloPSAKnowledgeBaseOperation | HaloPSAReportingOperation | HaloPSASitesOperation | HaloPSATicketsOperation |

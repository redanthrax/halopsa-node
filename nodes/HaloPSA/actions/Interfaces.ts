...
export type HaloPSAResource = 'actions' | 'agents' | 'appointments' | 'assets' | 'attachments' | 'client' | 'contracts' | 'customApi' | 'fieldInfo' | 'invoices' | 'knowledgeBase' | 'lookups' | 'opportunities' | 'quotations' | 'reporting' | 'sites' | 'surveys' | 'tickets' | 
